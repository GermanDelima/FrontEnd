...
export class HeaderService {
  ...
  public getUser():Observable<Usuario>{
    return this.http.get<Usuario>(`${this.apiServerURL}/api/persona/traer/persona/1`);
  }

  //metodo para editar un user
  public updateUsuario(usuario: Usuario):Observable<Usuario>{
    return this.http.put<Usuario>(`${this.apiServerURL}/api/persona/editar/persona`,usuario);
  } 
}
